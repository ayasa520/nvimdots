...
local plug_map = {
    ...
    ["v|<leader>ca"] = map_cu("Lspsaga range_code_action"):with_noremap()
        :with_silent(),
    ["n|gd"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),
    ["n|gD"] = map_cr("lua vim.lsp.buf.definition()"):with_noremap()
        :with_silent(),
    ["n|gs"] = map_cr("Lspsaga signature_help"):with_noremap():with_silent(),
    ["n|gr"] = map_cr("Lspsaga rename"):with_noremap():with_silent(),
    ["n|gh"] = map_cr("Lspsaga lsp_finder"):with_noremap()
        :with_silent(),
    ...
    ["n|<leader>dr"] = map_cr("lua require('dap').continue()"):with_noremap() -- ,dr 继续
        :with_silent(),
    ["n|<leader>dd"] = map_cr("lua require('dap').disconnect()"):with_noremap() -- ,dd 断开链接
        :with_silent(),
    ["n|<leader>db"] = map_cr("lua require('dap').toggle_breakpoint()"):with_noremap() -- ,db 打开/关闭断点
        :with_silent(),
    ["n|<leader>dB"] = map_cr(
        "lua require('dap').set_breakpoint(vim.fn.input('Breakpoint condition: '))"):with_noremap() -- ,dB 设置条件断点
        :with_silent(),
    ...
    ["n|<leader>drl"] = map_cr("lua require('dap').run_last()"):with_noremap() -- ,drl ?
        :with_silent(),
    ["n|<F10>"] = map_cr("lua require('dap').step_over()"):with_noremap() -- F10 step over
        :with_silent(),
